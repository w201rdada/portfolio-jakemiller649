...
(note to self to address: traditional subways or light rail is also very expensive, and not flexible to changing city dynamics -- aka our metro in DC (they have lots of benefits too, but these are some cons))

At the same time, the prevalence of transportation network companies (TNCs) such as Uber and Lyft are exacerbating emissions problems. TNCs have contributed to declining public transit usage and increased total vehicle miles traveled (citation). Individuals use TNCs for trips they otherwise would not have driven, adding cars to the road, contributing to congestion. (Citation, the UC Davis people) 

(note to self: the term is "deadhead miles".. where drivers are circling without passengers long distances)
...
(note to self, RIP bridj  https://www.citylab.com/transportation/2017/05/bridj-is-dead-but-microtransit-isnt/525156/)
...
(note to self:  data might exclude low income neighborhoods. one thing to look at would be including hours past when metro is open and checking stores and restaurants closing times or openings to get at the workers who can't use public transportation)
